...
// Note: pages live under ``src/pages``.  To reach components in ``src/components``
// we only need to go up one level (``..``).  Using ``../../`` erroneously
// climbs two levels and resolves to the project root, which causes Vite
// import resolution failures.  See README for details.
...
// Import API and store hooks using one level up (src/api and src/store).
